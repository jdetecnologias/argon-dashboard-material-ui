...
export function Print(props){
    const {_className, collorFill} = props;

    return (
        <svg fill={collorFill} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  
        width="30px" height="30px" viewBox="0 0 487.381 487.381"
        xmlSpace="preserve" className={_className}>
            <g>
                <g>
...
Print.propTypes = {
    ...
    collorFill: PropTypes.string.isRequired
}
