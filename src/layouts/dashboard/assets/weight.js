...
export function Weight(props){
    ...
    return (
                ...
                className={_className} viewBox="0 0 299.799 299.799"
                preserveAspectRatio="xMidYMid meet">

                <g 
                 stroke="none">
                    <path style={{fill:colorFill,fillRule:"evenodd"}}  d="M287.2,282.152l-31.829-177.579c-1.281-7.149-7.501-12.353-14.765-12.353h-52.935c9.925-9.776,16.093-23.357,16.093-38.356
